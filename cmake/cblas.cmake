...
elseif(ALLSPARK_CBLAS MATCHES "ACCELERATE")
  if(NOT APPLE)
    message(FATAL_ERROR "ACCELERATE is only available on macOS")
  endif()
  find_library(ACCELERATE_FRAMEWORK Accelerate REQUIRED)
  list(APPEND ALLSPARK_PUBLIC_DEFINITIONS
       -DALLSPARK_USE_CBLAS_ -DALLSPARK_USE_ACCELERATE_)
  set(CBLAS_INCLUDE_DIR "")
  set(CBLAS_LIBRARY ${ACCELERATE_FRAMEWORK})
endif()
